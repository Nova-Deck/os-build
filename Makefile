...
test: verify-lock ## Run the offline bootctl/post-install/pairingd/quirks/stage-2/unit/coredump/update/publish/install/steamos-manager suites (host, no build needed)
