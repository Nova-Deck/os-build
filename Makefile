...
test: verify-lock ## Run the offline bootctl/post-install/pairingd/quirks/stage-2/unit/coredump/perf/fan-curve/decky/update/publish/install/steamos-manager suites (host, no build needed)
