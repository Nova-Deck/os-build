...
#
#   build/steam-seed/pack-seed.sh            -> out/steam-seed/steam-seed.tar.zst
...
# hours or months later, so it has to carry the tree with it. installer/mkimage.sh stages this file
...
log "sha256: $sha"
log "installer/mkimage.sh stages it into the medium, and writes that hash beside it as the pin"
