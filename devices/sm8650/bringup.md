...
WSI-surface artifact, not a capability gap — the panel already works, step 4.) Steps 3/7/8
are off the gate's critical path (step 5 Input now green — InputPlumber on Pocket S2).
