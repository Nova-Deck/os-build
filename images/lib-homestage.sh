...
# /home is written twice -- once by images/make-sdcard.sh into a card image at build time, and once
...
# uid/gid 1000, baked into the base by images/customize-base.sh. Numeric rather than resolved
