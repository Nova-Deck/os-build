...
# novadeck hardware-staging library — sourced by install/hw-select-target.sh and
# install/hw-install.sh. Not executable, not shipped: it exists on the BUILD HOST only.
#
