"""
Lay one screen out against installer/fakepygame.py and report where it landed.

    SCR_W=1920 SCR_H=1080 DESC='desc = {...}' python3 installer/layout-probe.py
...
installer/uiview.py imports pygame lazily, inside the view, so injecting the stand-in before the
