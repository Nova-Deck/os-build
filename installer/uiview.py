...
# rather than a class in installer/ui so that the separation is physical instead of a convention. The
# whole state machine — screens, the consent socket, the spine driver — lives in installer/ui and
# imports nothing from here; installer/ui loads THIS module lazily, only when there is a display to
