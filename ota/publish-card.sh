...
#
#   image/card-meta.sh <image-file>                     -> out/images/release-meta/
#   ota/publish-card.sh <version> <image-file> <metadir>
#
...
[ -f "$stage/sha256sums.txt" ] || die "no metadata at $stage — run image/card-meta.sh '$IMG' first"
