...
#
# THREE CALLERS, ONE FORMULA, and they have to agree or the build breaks in confusing ways:
#
...
# reviewed sources. It is a WEAKER claim about the artifact (anyone who can write work/repo can
# substitute one) and a STRONGER one about provenance. See TODO.md and images/fetchlock.sh.
#
